...
import {
  Phone, CheckCircle, Clock, XCircle, CalendarClock, PhoneCall,
...
function StatCard({ label, value, icon: Icon, gradient, delay }: {
  ...
  return (
    <div
      className="rounded-xl border border-border/40 bg-card p-4 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-0.5 animate-slide-up"
    ...
    <div className="flex h-full flex-col overflow-hidden">
      <div className="shrink-0 space-y-4 pb-4">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <PageHeader title="Admin Dashboard" subtitle="Overview of all operations and call management" />
